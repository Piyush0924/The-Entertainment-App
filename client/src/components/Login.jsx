                    ...
                    {isLogin && (
                        <>
                            <p className="text-sm text-center text-gray-400 mt-2">
                                Login may take <span className="text-red-500 font-medium">45–5 sec</span> using demo credentials.
                            </p>
                            <button
                                type="button"
                                className="w-full mt-2 py-2 border border-red-500 text-red-500 hover:bg-red-600 hover:text-white font-medium rounded transition duration-150"
