            ...
            <div className="flex h-screen">
                ...
                <div className="flex-1 overflow-auto p-4 bg-gray-950">
                    ...
                    <Routes>
                        ...
                        <Route path="/movieshow" element={<Movieshow title="Movies" fetchURL={[requests.requestPopular]} />} />
                        <Route path="/tvshow" element={<Tvshow title="TV Series" fetchURL={requests.requestTopRatedtv} />} />
